"""
Курсовой проект. Курс Python Advanced
Завдання 1
"""
...
def parse_weather_data(data):
    ...
    msg = f'Погода у місті {city}: температура становить {temp} °C; атмосферні явища: {weather_state} ({details})'
    return msg
